...
pa: [
    ...
    ext: [
      {
        ...
        name: 'Cubierta Sobreelevada del Pasillo (Monitor Roof / Linternilla)',
        tags: ['Nivel +6.70 m (+3.40m libre)', 'Aleros Volados Antilluvia', 'Iluminación Cenital', 'Efecto Chimenea'],
        specs: {
          'Ubicación': 'Eje Central de Azotea sobre el pasillo de distribución (X = 3.00m a 12.67m, Y = -5.05m a -6.55m)',
          'Beneficio': 'Sobreeleva el techo del pasillo 70 cm por encima de la losa general (+2.70m -> +3.40m), con aleros volados que impiden la entrada de agua y celosías laterales que inundan el distribuidor de luz natural y evacúan el aire caliente por tiro térmico natural'
        }
      },
      {
        id: 'paneles_solares_ext',
        name: 'Arreglo Fotovoltaico Solar (6 Paneles Tier 1)',
        tags: ['3.3 kWp Potencia', '6 Módulos de 550W', 'Inclinación 18° Sur', 'Autosuficiencia'],
        specs: {
          'Ubicación': 'Losa de Azotea Norte (Azimut 180°)',
          'Producción': '~450 kWh/mes para alimentar domótica, iluminación y refrigeración',
          'Inversor': 'Inversor Híbrido Smart en Cuarto de Máquinas de PB con monitoreo en Home Assistant'
        }
      },
      {
        id: 'clima_condensadoras_ext',
        name: 'Condensadoras A/C Inverter Multi-Split',
        tags: ['3 Unidades Exteriores', 'Basamentos Anti-vibratorios', 'Shaft Técnico Directo'],
        specs: {
          'Ubicación': 'Zona Sur de Azotea sobre soportes de neopreno para cero transmisión acústica',
          'Conexión': 'Líneas frigoríficas bajan por el shaft vertical directo a recámaras y área social'
        }
      },
      {
        id: 'drenaje_pluvial_ext',
        name: 'Sistema de Captación y Drenaje Pluvial',
        tags: ['Pendientes 2%', 'Bajantes BAP 4"', 'Filtro Hacia Cisterna'],
        specs: {
          'Pendientes': 'Losa con pendiente perimetral hacia bajantes BAP de 4 pulgadas con filtro de hojas y sedimentos hacia la cisterna de 5,000 L'
        }
      }
    ]
  };
  ...
  function getExteriorRoofSVG() {
    return `<svg viewBox="0 0 920 580" width="100%" height="560" xmlns="http://www.w3.org/2000/svg" style="font-family: 'Plus Jakarta Sans', -apple-system, sans-serif; background-color: #fafbfc; border-radius: 12px;">
        ...
        <!-- Cubierta de Azotea Principal (Nivel +6.00 m - Huella de Planta Alta) -->
        <g id="losa-azotea-principal" filter="url(#roofShadow)">
          <polygon points="200,102 586.8,102 586.8,452 200,452" fill="url(#roofGrad)" stroke="hsl(215, 30%, 65%)" stroke-width="2" />
          <!-- Pendientes y bajadas pluviales BAP -->
          <line x1="200" y1="102" x2="393.4" y2="182" stroke="hsl(215, 20%, 75%)" stroke-width="0.8" stroke-dasharray="4,3" />
          <line x1="586.8" y1="102" x2="393.4" y2="182" stroke="hsl(215, 20%, 75%)" stroke-width="0.8" stroke-dasharray="4,3" />
          <circle cx="210" cy="112" r="5" fill="hsl(200, 70%, 45%)" />
          <text x="210" y="114" text-anchor="middle" font-size="4" font-weight="800" fill="#ffffff">BAP</text>
        </g>

        <!-- Arreglo Fotovoltaico Solar (6 Paneles de 550W = 3.3 kWp en Ala Norte) -->
        <g id="paneles-solares-norte" transform="translate(230, 120)">
          <rect x="0" y="0" width="180" height="110" rx="4" fill="hsl(215, 80%, 22%)" stroke="hsl(215, 90%, 50%)" stroke-width="1.5" />
          <line x1="60" y1="0" x2="60" y2="110" stroke="#ffffff" stroke-width="0.8" stroke-dasharray="2,2" />
          <line x1="120" y1="0" x2="120" y2="110" stroke="#ffffff" stroke-width="0.8" stroke-dasharray="2,2" />
          <line x1="0" y1="55" x2="180" y2="55" stroke="#ffffff" stroke-width="0.8" stroke-dasharray="2,2" />
          <rect x="25" y="42" width="130" height="26" rx="3" fill="hsl(215, 90%, 15%)" stroke="hsl(215, 90%, 60%)" stroke-width="0.8" />
          <text x="90" y="54" text-anchor="middle" font-size="7" font-weight="900" fill="#ffffff">6x PANELES SOLARES MONOCRISTALINOS</text>
          <text x="90" y="64" text-anchor="middle" font-size="6" font-weight="700" fill="hsl(45, 95%, 60%)">Potencia: 3.3 kWp (Bifaciales 550W)</text>
        </g>

        <!-- Domo / Tragaluz en Escalera -->
        <g id="tragaluz-escalera" transform="translate(490, 175)">
          <rect x="0" y="0" width="80" height="55" rx="3" fill="hsl(195, 85%, 85%)" stroke="hsl(195, 95%, 45%)" stroke-width="1.5" />
          <line x1="0" y1="0" x2="80" y2="55" stroke="hsl(195, 95%, 45%)" stroke-width="0.8" />
          <line x1="80" y1="0" x2="0" y2="55" stroke="hsl(195, 95%, 45%)" stroke-width="0.8" />
          <rect x="10" y="18" width="60" height="18" rx="2" fill="#ffffff" stroke="hsl(195, 95%, 45%)" stroke-width="0.6" />
          <text x="40" y="30" text-anchor="middle" font-size="6" font-weight="800" fill="hsl(195, 90%, 25%)">DOMO ESCALERA</text>
        </g>

        <!-- Compresores Mini-Split Inverter en Ala Sur -->
        <g id="compresores-clima" transform="translate(230, 365)">
          <rect x="0" y="0" width="34" height="22" rx="2" fill="hsl(220, 20%, 35%)" />
          <circle cx="17" cy="11" r="7" fill="#111111" />
          <rect x="44" y="0" width="34" height="22" rx="2" fill="hsl(220, 20%, 35%)" />
          <circle cx="61" cy="11" r="7" fill="#111111" />
          <rect x="88" y="0" width="34" height="22" rx="2" fill="hsl(220, 20%, 35%)" />
          <circle cx="105" cy="11" r="7" fill="#111111" />
          <text x="61" y="33" text-anchor="middle" font-size="6" font-weight="800" fill="hsl(220, 25%, 30%)">3x CONDENSADORAS A/C INVERTER</text>
        </g>

        <!-- ====================================================================
             CUBIERTA SOBREELEVADA DEL PASILLO PRINCIPAL (MONITOR ROOF / LINTERNILLA)
             - Altura Libre Pasillo: +3.40 m (+70 cm sobre losa general de +2.70 m)
             - Cota Azotea Sobreelevada: +6.70 m
             - Aleros Volados de 30 cm que protegen de lluvia
             - Celosías / Ventilas Laterales para iluminación cenital y tiro térmico
             ==================================================================== -->
        <g id="monitor-roof-pasillo" filter="url(#roofShadow)">
          <!-- Franja de Celosía / Ventilación e Iluminación Cenital Norte y Sur -->
          <rect x="190" y="254" width="406.8" height="76" rx="6" fill="hsl(35, 40%, 88%)" stroke="hsl(35, 75%, 45%)" stroke-width="1.5" />

          <!-- Celosías Laterales con Louvers / Lamas Antilluvia -->
          <g id="louvers-norte">
            <rect x="200" y="256" width="386.8" height="8" fill="hsl(200, 85%, 85%)" stroke="hsl(200, 80%, 45%)" stroke-width="0.8" />
            <text x="393.4" y="262" text-anchor="middle" font-size="5" font-weight="800" fill="hsl(200, 85%, 30%)">◄ CELOSÍA LOUVERS NORTE (LUZ &amp; VENTILACIÓN PASIVA CROTALINA) ►</text>
          </g>
          <g id="louvers-sur">
            <rect x="200" y="320" width="386.8" height="8" fill="hsl(200, 85%, 85%)" stroke="hsl(200, 80%, 45%)" stroke-width="0.8" />
            <text x="393.4" y="326" text-anchor="middle" font-size="5" font-weight="800" fill="hsl(200, 85%, 30%)">◄ CELOSÍA LOUVERS SUR (EXTRACCIÓN DE CALOR CONVECTIVO / EFECTO CHIMENEA) ►</text>
          </g>

          <!-- Losa Sobreelevada con Alero Volado Protector de Lluvia (Nivel +6.70 m) -->
          <rect x="185" y="260" width="416.8" height="64" rx="4" fill="url(#monitorRoofGrad)" stroke="hsl(35, 85%, 40%)" stroke-width="2" />
          
          <!-- Textura de Cubierta e Indicadores de Alero -->
          <line x1="185" y1="292" x2="601.8" y2="292" stroke="hsl(35, 60%, 65%)" stroke-width="1" stroke-dasharray="6,4" />

          <!-- Etiqueta de la Cubierta Sobreelevada -->
          <rect x="240" y="276" width="306.8" height="32" rx="4" fill="#ffffff" stroke="hsl(35, 85%, 45%)" stroke-width="1.2" opacity="0.96" />
          <text x="393.4" y="290" text-anchor="middle" font-size="8" font-weight="900" fill="hsl(35, 90%, 30%)">CUBIERTA SOBREELEVADA DEL PASILLO (NIVEL +6.70 m)</text>
          <text x="393.4" y="302" text-anchor="middle" font-size="6.5" font-weight="700" fill="hsl(220, 25%, 35%)">Aleros Volados Protección Lluvia • Iluminación Cenital • Ventilación Efecto Chimenea</text>
        </g>

        <!-- Banner Azotea -->
        <g id="banner-azotea" transform="translate(200, 68)">
          <rect x="0" y="0" width="386.8" height="24" rx="4" fill="hsl(145, 75%, 30%)" />
          <text x="193.4" y="16" text-anchor="middle" font-size="8" font-weight="800" fill="#ffffff">EXTERIOR &amp; AZOTEA (NIVEL +6.00 m / +6.70 m) • CUBIERTA SOBREELEVADA + SOLAR</text>
        </g>
