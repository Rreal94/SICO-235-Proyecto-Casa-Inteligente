...
pa: [
    ...
    ext: [
      {
        ...
        specs: {
          'Ubicación': 'Losa de Azotea orientada al Sur (Azimut 180°)',
      ...
      },
      {
        ...
        specs: {
          'Pendientes': 'Losa con pendiente del 2% hacia esquinas con bajantes directas',
          'Aprovechamiento': 'Agua pluvial filtrada y canalizada hacia cisterna de riego'
        }
      }
    ]
  };
  ...
  function getExteriorRoofSVG() {
    return `<svg viewBox="0 0 880 580" width="100%" height="560" xmlns="http://www.w3.org/2000/svg" style="font-family: 'Plus Jakarta Sans', -apple-system, sans-serif; background-color: #fafbfc; border-radius: 12px;">
        ...
        <rect width="880" height="580" fill="url(#gridPatternExt)" />
        <rect width="880" height="580" fill="url(#gridPatternExt1m)" />
        
        <!-- Límite Terreno -->
        <polygon points="80,60 710,60 660,469 80,462" fill="none" stroke="hsl(220, 20%, 75%)" stroke-width="1.8" stroke-dasharray="6,4" />
        
        <!-- Cubierta de Azotea Principal (Nivel +6.00 m) -->
        <polygon points="200,102 586.8,102 586.8,452 200,452" fill="hsl(210, 20%, 93%)" stroke="hsl(215, 30%, 70%)" stroke-width="2" />
        
        <!-- Arreglo Fotovoltaico Solar (6 Paneles de 550W = 3.3 kWp) -->
        <g id="paneles-solares" transform="translate(240, 140)">
          <rect x="0" y="0" width="180" height="120" rx="4" fill="hsl(215, 75%, 25%)" stroke="hsl(215, 90%, 50%)" stroke-width="1.5" />
          <line x1="60" y1="0" x2="60" y2="120" stroke="#ffffff" stroke-width="0.8" stroke-dasharray="2,2" />
          <line x1="120" y1="0" x2="120" y2="120" stroke="#ffffff" stroke-width="0.8" stroke-dasharray="2,2" />
          <line x1="0" y1="60" x2="180" y2="60" stroke="#ffffff" stroke-width="0.8" stroke-dasharray="2,2" />
          <text x="90" y="65" text-anchor="middle" font-size="7.5" font-weight="900" fill="#ffffff">6x PANELES SOLARES (3.3 kWp)</text>
        </g>

        <!-- Domo / Tragaluz sobre Escalera -->
        <rect x="470" y="120" width="80" height="50" rx="3" fill="hsl(195, 85%, 85%)" stroke="hsl(195, 95%, 45%)" stroke-width="1.5" />
        <text x="510" y="148" text-anchor="middle" font-size="6.5" font-weight="800" fill="hsl(195, 90%, 25%)">TRAGALUZ ESCALERA</text>

        <!-- Compresores Mini-Split Inverter -->
        <g id="compresores-clima" transform="translate(480, 360)">
          <rect x="0" y="0" width="30" height="20" rx="2" fill="hsl(220, 20%, 40%)" />
          <circle cx="15" cy="10" r="6" fill="#111111" />
          <rect x="40" y="0" width="30" height="20" rx="2" fill="hsl(220, 20%, 40%)" />
          <circle cx="55" cy="10" r="6" fill="#111111" />
          <text x="35" y="32" text-anchor="middle" font-size="5.5" font-weight="700" fill="hsl(220, 25%, 35%)">COMPRESORES A/C</text>
        </g>

        <!-- Banner Azotea -->
        <g id="banner-azotea" transform="translate(200, 70)">
          <rect x="0" y="0" width="386.8" height="24" rx="4" fill="hsl(145, 75%, 30%)" />
          <text x="193.4" y="16" text-anchor="middle" font-size="8.5" font-weight="800" fill="#ffffff">EXTERIOR &amp; AZOTEA (NIVEL +6.00 m) • ENERGÍA SOLAR FOTOVOLTAICA + CLIMA</text>
        </g>
